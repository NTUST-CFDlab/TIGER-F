 MODULE variables
    ...
    real*8, parameter            :: dt           = 5.d0*1.0e-4
    ...
    real*8, parameter            :: ly           = 14.d0

    real*8, parameter            :: lz           = 24.d0

    character(len=20)            :: Gridder      = 'non-uniform-sin5'  !non-uniform, uniform, non-uniform-sin, non-uniform-sin2, non-uniform-sin3, non-uniform-sin4 (Kuyper)

    !--------------------- Unequal grid ---------------------!

    real*8, parameter            :: GridderYc        = ly/2.d0		! Center coordinate of small grid
    real*8, parameter            :: GridderZc        = 7.d0

    real*8, parameter            :: lySml            = 1.05
    integer, parameter           :: nySml            = 210			

    real*8, parameter            :: lyMid            = 4.0			! for Gridder: non-uniform, non-uniform-sin, non-uniform-sin2
    integer, parameter           :: nyMid            = 118			! 'Only' nyMid

    real*8, parameter            :: lzSml            = 1.05
    integer, parameter           :: nzSml            = 210 			

    real*8, parameter            :: lzMid            = 4.0			! for Gridder: non-uniform, non-uniform-sin, non-uniform-sin2
    integer, parameter           :: nzMid            = 118			! 'Only' nzMid
