...
MODULE variables
    ...
    ! real*8, parameter            :: nu           	   = 1.d-4	! Kinematic viscosity (comment if dimensionless)
    ...
    integer, parameter           :: nx           = 64    				  !Must be an even number if RBSOR is used
			integer, parameter 	 :: nxLow 		 = 6					  !number of grid in lower side for non-uniform-fall
    ...
    real*8, parameter            :: GridderYc    = 25.d0            ! Center coordinate of fine grid, GridderXc is set at lx/2. Set wrt. the geometry x0 and y0.
    ...
    real*8, parameter            :: z0                  = 25.d0                 ! Geometry's origin
    ...
    real*8            			 :: U_solid_approx = blade_alpha  ! Not used in simulation (only to inform the approximate yPlus)
    ...
    integer                                          :: isto3d, isto2d, istocp, isto3davg
	
    real*8                                           :: isto_int, istea_int, backup_int, coeff_start
	
	real*8                                           :: startfiler3d_time, startfiler2d_time, startfilerAvg_time

	real*8                                           :: isto3d_int, isto2d_int, istocp_int, istoAvg_int
