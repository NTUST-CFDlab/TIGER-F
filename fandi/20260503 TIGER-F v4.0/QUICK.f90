...
!$acc data present(iDx,iDy,iDz,Dxs,Dys,Dzs,nut(:,:,istart:iend+1),theta(:,:,istart-2:iend+2), &
...
!$acc	u_star(:,:,istart-2:iend+2),v_star(:,:,istart-2:iend+2),w_star(:,:,istart-2:iend+2))
  ...
  !$OMP PARALLEL
   !$OMP DO               PRIVATE(u_tilde_x1,u_tilde_x2,v_tilde_x1,v_tilde_x2,w_tilde_x1,w_tilde_x2,ue,uw,un,us,uf,ub,idds,Viseff) COLLAPSE(3)
   !$acc parallel
...
!!! v_star calculation (y component) !!!
   ...
   !$OMP DO               PRIVATE(u_tilde_y1,u_tilde_y2,v_tilde_y1,v_tilde_y2,w_tilde_y1,w_tilde_y2,ve,vw,vn,vs,vf,vb,idds,Viseff) COLLAPSE(3)
...
!!! w_star calculation (z component) !!!
   ...
   !$OMP DO               PRIVATE(u_tilde_z1,u_tilde_z2,v_tilde_z1,v_tilde_z2,w_tilde_z1,w_tilde_z2,we,ww,wn,ws,wf,wb,idds,Viseff) COLLAPSE(3)
