...
implicit none
   ...
   write(21,'(3(3X,G18.10E3))') time, cDrag, cLift
   !write(21,*) time, AOA, cDrag, cLift

   ! write(31,'(8(3X,G18.10E3))') time, AOA, cTorq, cPower, cPower_in, cPower_nett, T_gen, P_gen

   ! For individual blade Magnus VAWT----------------------------
   ! write(72,'(3(3X,G18.10E3))') time, cDrag1, cLift1  
   ! write(73,'(3(3X,G18.10E3))') time, cDrag2, cLift2 
   ! write(74,'(3(3X,G18.10E3))') time, cDrag3, cLift3 
   ! write(75,'(5(3X,G18.10E3))') time, AOA, cTorq1, cPower1, cPower1_in
   ! write(76,'(5(3X,G18.10E3))') time, AOA, cTorq2, cPower2, cPower2_in
   ! write(77,'(5(3X,G18.10E3))') time, AOA, cTorq3, cPower3, cPower3_in
   ! ------------------------------------------------------------


   ! For individual tandem cylinder/airfoils---------------------
   ! write(87,'(6(3X,G18.10E3))') time, y0_t1, v_solid_1, cDrag1, cLift1, cPower1
   ! write(88,'(6(3X,G18.10E3))') time, y0_t2, v_solid_2, cDrag2, cLift2, cPower2
   ! ------------------------------------------------------------   
