...
!----------------------------------------------------------------------!
	...
	! ! Rotate the 2nd blade center with AOA (needed to define the blade rotation)
		...
		! z0_t2= COS((AOA+180.d0)*PI/180.d0)*(rotor_r)
		! y0_t2= SIN((AOA+180.d0)*PI/180.d0)*(rotor_r)
...
real*8		:: k1_v_solid_1,k2_v_solid_1,k3_v_solid_1,k4_v_solid_1
real*8		:: k1_v_solid_2,k2_v_solid_2,k3_v_solid_2,k4_v_solid_2
real*8		:: k1_y_solid_1,k2_y_solid_1,k3_y_solid_1,k4_y_solid_1
real*8		:: k1_y_solid_2,k2_y_solid_2,k3_y_solid_2,k4_y_solid_2
real*8		:: ay_short1,ay_short2
...
!----------------------------------------------------------------------!
	...
	!---------- For VIV of tandem cylinder (RK4)-----------
	...
	! ! --> dy/dt = f(v_solid)) = v_solid
		...
		! !---------- For cylinder1-----------
		! ay_short1 =  (-1.d0 * totalFY1_) / (den_flu * (den_sol / den_flu) * solid_volume_1)

		! k1_v_solid_1 = dv_dt(ay_short1 , y0_t1 , y01 , v_solid_1)
		! k1_y_solid_1 = dy_dt(v_solid_1)
	
		! k2_v_solid_1 = dv_dt(ay_short1 , y0_t1+0.5d0*k1_y_solid_1*dt , y01 , v_solid_1+0.5d0*k1_v_solid_1*dt)
		! k2_y_solid_1 = dy_dt(v_solid_1+0.5d0*k1_v_solid_1*dt)

		! k3_v_solid_1 = dv_dt(ay_short1 , y0_t1+0.5d0*k2_y_solid_1*dt , y01 , v_solid_1+0.5d0*k2_v_solid_1*dt)
		! k3_y_solid_1 = dy_dt(v_solid_1+0.5d0*k2_v_solid_1*dt)

		! k4_v_solid_1 = dv_dt(ay_short1 , y0_t1+k3_y_solid_1*dt , y01 , v_solid_1+k3_v_solid_1*dt)
		! k4_y_solid_1 = dy_dt(v_solid_1+k3_v_solid_1*dt)
	
		! v_solid_1 = v_solid_1 + (1.d0 / 6.d0) * (k1_v_solid_1 + 2.d0 * k2_v_solid_1 + 2.d0 * k3_v_solid_1 + k4_v_solid_1) * dt	
		! y0_t1 = y0_t1 + (1.d0 / 6.d0) * (k1_y_solid_1 + 2.d0 * k2_y_solid_1 + 2.d0 * k3_y_solid_1 + k4_y_solid_1) * dt
		! !-------------------------------------------------

		! !---------- For cylinder2-----------
		! ay_short2 =  (-1.d0 * totalFY2_) / (den_flu * (den_sol / den_flu) * solid_volume_2)

		! k1_v_solid_2 = dv_dt(ay_short2 , y0_t2 , y02 , v_solid_2)
		! k1_y_solid_2 = dy_dt(v_solid_2)
	
		! k2_v_solid_2 = dv_dt(ay_short2 , y0_t2+0.5d0*k1_y_solid_2*dt , y02 , v_solid_2+0.5d0*k1_v_solid_2*dt)
		! k2_y_solid_2 = dy_dt(v_solid_2+0.5d0*k1_v_solid_2*dt)

		! k3_v_solid_2 = dv_dt(ay_short2 , y0_t2+0.5d0*k2_y_solid_2*dt , y02 , v_solid_2+0.5d0*k2_v_solid_2*dt)
		! k3_y_solid_2 = dy_dt(v_solid_2+0.5d0*k2_v_solid_2*dt)

		! k4_v_solid_2 = dv_dt(ay_short2 , y0_t2+k3_y_solid_2*dt , y02 , v_solid_2+k3_v_solid_2*dt)
		! k4_y_solid_2 = dy_dt(v_solid_2+k3_v_solid_2*dt)
	
		! v_solid_2 = v_solid_2 + (1.d0 / 6.d0) * (k1_v_solid_2 + 2.d0 * k2_v_solid_2 + 2.d0 * k3_v_solid_2 + k4_v_solid_2) * dt	
		! y0_t2 = y0_t2 + (1.d0 / 6.d0) * (k1_y_solid_2 + 2.d0 * k2_y_solid_2 + 2.d0 * k3_y_solid_2 + k4_y_solid_2) * dt
		! !-------------------------------------------------
	...
	! ! rotor_omega = rotor_omega + (- totalTorq - T_gen)*dt/I_moment
	...
	! ! --> d_omega/dt = f(rotor_omega) = (- totalTorq - P_gen/rotor_omega)/I_moment
	...
	! !-------------------For Darrius VAWT ------------------
	! rotor_omega = rotor_omega - totalTorq*dt/I_moment
...
!------------------Runge-Kutta functions for VIV of tandem cylinder (RK4)-------------------------------------
! FUNCTION dv_dt(ay_short_,y0_t_,y0_,v_solid_) result(dv_dt_)
! USE variables
! IMPLICIT NONE
! real*8, intent(in) :: ay_short_,y0_t_,y0_,v_solid_
! real*8		:: dv_dt_

! dv_dt_ =  ay_short_ - k_spring * (y0_t_ - y0_) - c_damper * v_solid_
...
! domega_dt_ =  (- totalTorq - P_gen/rotor_omega_)/I_moment
