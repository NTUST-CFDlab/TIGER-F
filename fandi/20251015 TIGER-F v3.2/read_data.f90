...
subroutine read_data()
   ...
   isto3d       = INT(isto3d_int/dt)          		 	 ! filer3d data storing steps interval
   istoVF		= INT(istoVF_int/dt)					 ! Virtual force data storing steps interval
   istoAvg    	= INT(istoAvg_int/dt)          		 	 ! TKE data storing steps interval
   isto2d       = INT(isto2d_int/dt)          		 	 ! filer2d data storing steps interval
   istocp       = INT(istocp_int/dt)          		 	 ! cp data storing steps interval
   ibackup	 	= INT(backup_int/dt)          	     	 ! backup data stored every 'ibackup' steps
