...
!$OMP			  REDUCTION(max : az_max,ay_max) REDUCTION(min : az_min,ay_min) collapse(1)
...
!$OMP			  REDUCTION(min : az_min,ay_min) collapse(1)
!$acc parallel vector_length(32)
...
! !$OMP PARALLEL DO PRIVATE(i,j,DIAGONAL,DISTANCE,SDIST,l,m,n,dxg,dyg,dzg,SX,SY,SZ,xi) collapse(1)
...
!$OMP			  REDUCTION(min : az_min,ay_min,ax_min) collapse(1)
!$acc parallel vector_length(32)
