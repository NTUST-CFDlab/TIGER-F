...
program main
   ...
   itmax                            = 2500                  ! maximum for zeta in Gauss Seidel subroutines
   ...
   nstep                            = INT(60.d0/dt)         ! number of timesteps for the simulation
   ...
   if(Gridder=='non-uniform')then
      ...
      call gridder_sin2()             ! define equal mesh
...
!
      ...
      if(myid==master)then
         ...
         if (time > 0.1d0 .AND. mod(istep,INT(0.01d0/dt))==0) then
