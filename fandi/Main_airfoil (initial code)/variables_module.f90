 MODULE variables
    ...
    real*8, parameter            :: Re           = 2.e+4

    real*8, parameter            :: dt           = 2.5d0*1.0e-4

    integer, parameter           :: nx           = 20

    integer, parameter           :: ny           = 500

    integer, parameter           :: nz           = 650

    real*8, parameter            :: lx           = 0.2d0

    real*8, parameter            :: ly           = 10.d0

    real*8, parameter            :: lz           = 14.d0

    character(len=20)            :: Gridder      = 'non-uniform-sin'  !non-uniform, uniform

    !--------------------- Unequal grid ---------------------!

    real*8, parameter            :: GridderYc        = 4.925d0
    real*8, parameter            :: GridderZc        = 5.94d0

    real*8, parameter            :: lySml            = 0.35
    integer, parameter           :: nySml            = 270

    real*8, parameter            :: lyMid            = 0.68
    integer, parameter           :: nyMid            = 390

    real*8, parameter            :: lzSml            = 1.1
    integer, parameter           :: nzSml            = 440 

    real*8, parameter            :: lzMid            = 1.8
    integer, parameter           :: nzMid            = 560
    ...
    real*8, parameter            :: xc                  = 0.05d0

    real*8, parameter            :: yc                  = 5.d0

    real*8, parameter            :: zc                  = 6.d0
