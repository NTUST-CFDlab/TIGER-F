...
!$acc data present(iDx,iDy,iDz,FX(:,:,istart-2:iend+2),FY(:,:,istart-2:iend+2),FZ(:,:,istart-2:iend+2))
   ...
   !$OMP PARALLEL DO      REDUCTION(+: totalFZ, totalFY) COLLAPSE(3)
   !$acc parallel
...
!$acc data present(iDx,iDy,iDz,Xs,Ys,Zs,FX(:,:,istart-2:iend+2),FY(:,:,istart-2:iend+2),FZ(:,:,istart-2:iend+2))
	...
	!$OMP PARALLEL	
	!$OMP DO               REDUCTION(+: totalFZ, totalFY) COLLAPSE(3)
	!$acc parallel
	!$acc loop independent reduction(+: totalFZ, totalFY) collapse(3) gang vector
	do k=istart,iend 
	do j=1,ny;do i=1,nx
    ...
    !$OMP DO               REDUCTION(+: totalTZ, totalTY) COLLAPSE(3)
...
!$acc data present(iDx,iDy,iDz,Zs,FX(:,:,istart-2:iend+2),FY(:,:,istart-2:iend+2),FZ(:,:,istart-2:iend+2))
   ...
   !$OMP PARALLEL DO      REDUCTION(+: totalFZ1, totalFY1, totalFZ2, totalFY2) COLLAPSE(3)
   !$acc parallel
...
!$acc data present(iDx,iDy,iDz,Xs,Ys,Zs,FX(:,:,istart-2:iend+2),FY(:,:,istart-2:iend+2),FZ(:,:,istart-2:iend+2))
	...
	!$OMP PARALLEL	
	!$OMP DO               REDUCTION(+: totalFZ1, totalFY1, totalFZ2, totalFY2) COLLAPSE(3)
	!$acc parallel
	!$acc loop independent reduction(+: totalFZ1, totalFY1, totalFZ2, totalFY2) collapse(3) gang vector
	do k=istart,iend 
	do j=1,ny;do i=1,nx
    ...
    !$OMP DO               REDUCTION(+: totalTZ1, totalTY1, totalTZ2, totalTY2) COLLAPSE(3)
    ...
    !$OMP DO               REDUCTION(+: totalTZ1_in, totalTY1_in, totalTZ2_in, totalTY2_in) COLLAPSE(3)
...
!$acc data present(iDx,iDy,iDz,Xs,Ys,Zs,FX(:,:,istart-2:iend+2),FY(:,:,istart-2:iend+2),FZ(:,:,istart-2:iend+2))
	...
	!$OMP PARALLEL	
	!$OMP DO               REDUCTION(+: totalFZ1, totalFY1, totalFZ2, totalFY2, totalFZ3, totalFY3) COLLAPSE(3)
	!$acc parallel
    ...
    !$OMP DO               REDUCTION(+: totalTZ1, totalTY1, totalTZ2, totalTY2, totalTZ3, totalTY3) COLLAPSE(3)
...
!$acc data present(iDx,iDy,iDz,Xs,Ys,Zs,FX(:,:,istart-2:iend+2),FY(:,:,istart-2:iend+2),FZ(:,:,istart-2:iend+2))
	...
	!$OMP PARALLEL	
	!$OMP DO               REDUCTION(+: totalFX, totalFZ, totalFY) COLLAPSE(3)
	!$acc parallel
    ...
    !$OMP DO               REDUCTION(+: totalT_XZ, totalT_XY, totalT_YZ, totalT_YX, totalT_ZY, totalT_ZX) COLLAPSE(3)
