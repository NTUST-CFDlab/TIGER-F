...
implicit none
   ...
   write(21,'(3G18.10E3)') time, cDrag, cLift
   !write(21,*) time, AOA, cDrag, cLift

   ! write(31,'(8G18.10E3)') time, AOA, cTorq, cPower, cPower_in, cPower_nett, T_gen, P_gen

   ! For individual blade Magnus VAWT----------------------------
   ! write(72,'(3G18.10E3)') time, cDrag1, cLift1  
   ! write(73,'(3G18.10E3)') time, cDrag2, cLift2 
   ! write(74,'(3G18.10E3)') time, cDrag3, cLift3 
   ! write(75,'(5G18.10E3)') time, AOA, cTorq1, cPower1, cPower1_in
   ! write(76,'(5G18.10E3)') time, AOA, cTorq2, cPower2, cPower2_in
   ! write(77,'(5G18.10E3)') time, AOA, cTorq3, cPower3, cPower3_in
   ! ------------------------------------------------------------
