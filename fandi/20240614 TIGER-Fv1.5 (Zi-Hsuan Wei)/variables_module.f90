...
MODULE variables
    ...
    real*8, parameter            :: Re           		= 3900.d0	! Reynolds number (comment if dimensional)
    ...
    integer, parameter           :: nx           = 16				  ! Must be an even number if RBSOR is used
    ...
    real*8                                  :: pNew, pChange, omega, pChangeMax
...
!
    ...
    real*8                                         :: totalTZ, totalTY, totalTorq

    real*8                                         :: totalTZ_, totalTY_, totalTorq_
